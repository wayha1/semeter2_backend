  ...
  return (
    <>
      <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        <h1 className="w-full flex justify-center font-semibold text-4xl pb-10">Your Favorite</h1>
              ...
              <div className="relative">
                ...
                >
                  <svg
                    ...
                    fill={favorites.includes(product) ? 'red' : 'none'}
                    viewBox="0 0 24 24"
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="w-8 h-8"
        ...
        <h2 className="w-full flex justify-center font-semibold text-3xl pt-10">Favorited Products</h2>
