  ...
  return (
    <>
      <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        <h1 class="w-full flex justify-center font-semibold text-4xl pb-10">
          Your Favorite
        </h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          <div class="rounded overflow-hidden shadow-lg flex flex-col">
            ...
            <div class="relative">
              ...
              <a href="#!">
                <div class="text-xs absolute top-0 right-0  text-white mt-3 mr-3  transition duration-500 ease-in-out">
                  <svg
