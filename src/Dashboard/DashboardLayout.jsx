    ...
    <div className="flex">
      ...
      >
        <div className="flex h-auto flex-col w-full text-gray-700 bg-white flex-shrink-0">
          ...
          >
            <div onClick={() => setDashboardDropdown(!dashboardDropdown)} className="relative">
              <Button
                ...
                hover:text-white bg-transparent rounded-lg 
                dark-mode:bg-transparent dark-mode:hover:bg-blue-600 
                dark-mode:focus:bg-blue-600 dark-mode:focus:text-white 
                dark-mode:hover:text-white dark-mode:text-white 
              ...
              <div
                style={{
                  display: dashboardDropdown ? "block" : "none",
                }}
