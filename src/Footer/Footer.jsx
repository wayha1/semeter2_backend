        ...
        <div className="flex justify-center">
          <div className="mr-6 text-neutral-600 dark:text-neutral-200">
            <svg
              ...
              className="h-4 w-4 hover:text-pink-500 "
              fill="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div className="mr-6 text-neutral-600 dark:text-neutral-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 hover:text-pink-500"
              fill="currentColor"
              viewBox="0 0 72 72"
            >
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="pl-10">
            ...
            <p className="mb-4">
              <div className="text-neutral-600 dark:text-neutral-200">Card</div>
            </p>
            <p className="mb-4">
              <div className="text-neutral-600 dark:text-neutral-200">
                Reviews
          ...
          <div className="pl-10">
            ...
            <p className="mb-4">
              <div className="text-neutral-600 dark:text-neutral-200">FAQs</div>
            </p>
            <p>
              <div className="text-neutral-600 dark:text-neutral-200">
                Terms & Conditions
          ...
          <div className="pl-10">
            ...
            <p className="mb-4  flex items-center justify-center md:justify-start hover:text-pink-500">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <p className=" flex items-center justify-center md:justify-start hover:text-pink-500 ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="mr-3 h-5 w-5"
